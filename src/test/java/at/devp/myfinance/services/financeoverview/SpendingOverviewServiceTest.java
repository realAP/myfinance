...
class SpendingOverviewServiceTest {
  ...
  void setUp() {
    ...
    investmentSpending1.setCategory(Category.INVESTITIONEN);
    ...
    investmentSpending2.setCategory(Category.INVESTITIONEN);
    ...
    vergnuegenSpending1.setCategory(Category.VERGNUEGEN);
    ...
    vergnuegenSpending2.setCategory(Category.VERGNUEGEN);
  ...
  void whenGivenTwoInvestmentAndTwoVergnuegenSpendingsThenReturnSpendingTableDto() {
    ...
    final var resultInvestment = findSpendingTableDtoByCategory(result, Category.INVESTITIONEN);
    assertThat(resultInvestment.getCategory(), is(Category.INVESTITIONEN));
    ...
    assertThat(resultVergnuegen.getCategory(), is(Category.VERGNUEGEN));
